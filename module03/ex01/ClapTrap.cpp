...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    if (this->_hitPoints <= 0 || this->_attackDamage <= 0)
    {
        this->_hitPoints = 0;
        std::cout << BACKYELLOW  << "ClapTrap " << this->_name << " has been destroyed!" << RESET << std::endl;
    }
    std::cout << RED << "ClapTrap " << this->_name << " receives " << amount << " points of damage. Available: " << this->_hitPoints << " Hit points!" << RESET << std::endl;
	std::cout << std::endl;
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
    ...
    this->_energyPoints -= 1;
    std::cout << GREEN << "ClapTrap " << this->_name << " repairs " << amount << " hit points, and now has " << this->_hitPoints << " Hit points!" << RESET << std::endl;
	std::cout << std::endl;
}
